...
Make sure to have [VSCode](https://code.visualstudio.com/download), a GitHub account and [Git](https://git-scm.com/) & [GitHub Desktop](https://desktop.github.com/download/) installed before-hand!
...
Follow [Joining A Project](https://github.com/CodeBotsStudio/Dysymmetrical/wiki/Joining-A-Project).
...
Download [Rokit](https://github.com/rojo-rbx/rokit?tab=readme-ov-file#windows) following their installation tutorial.

After that, install [Wally](https://wally.run/install) by running `rokit install`, a package manager required for this engine to work.
...
After that, execute `git pull upstream main --allow-unrelated-histories` to make the repo have the same commit history as Dysymmetrical to be able to get new commits
that add code to your existing code.
