...
The skin's model that'll be applied to the player will go in `ServerStorage/Assets/Characters/Skins/(CHARACTERTYPE)/(CHARACTERNAME)` with the same name as the script. If it isn't named the same it won't work.
